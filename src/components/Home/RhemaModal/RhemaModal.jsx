            ...
            { loading ? (
                ...
                <>
                    <div className='bg-secondary/90 rounded-lg w-full p-3 flex justify-between items-center mx-auto'>
                        <h1 className='text-white text-md sm:text-xl sm:pl-3'>My Child, here's my Rhema for you</h1>
                        <div className='text-2xl sm:text-3xl cursor-pointer text-white font-bold right-5 top-5' onClick={handleClose} >
                            <IoIosCloseCircle/>
                        </div>
